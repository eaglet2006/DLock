...
using System.Text;
using DLock.Framework.Reflection;

namespace DLock.Framework.IO
{
    public class LogFile<T>
    {
        ...
        public static void WriteErrorLog(Exception e, string format, params object[] args)
        {
            WriteErrorLog(string.Format(format, args), e);
        }
        ...
        {
            WriteErrorLog(string.Format(format, args));
        }
        ...
        public static void WriteAppLog(string format, params object[] args)
        {
            WriteAppLog(string.Format(format, args), true);
        }
